 ...
 * @author nam11
 */
public class Publisher2 extends javax.swing.JFrame {

    /**
     * Creates new form Publisher2
     */
    public Publisher2() {
        initComponents();   
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Publisher2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Publisher2().setVisible(true);
            }
        });
    }
