 ...
 * @author trang
 */
public class RegisterM extends javax.swing.JFrame implements IRegisterM{
    private RegisterMPresenter registerPresenter;
    ...
    public RegisterM() {
        initComponents();
        registerPresenter = new RegisterMPresenter(this);
